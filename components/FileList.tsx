    ...
    const fetchFiles = async () => {
        ...
        try {
            ...
            addToast({
                ...
                description:
                    "We couldn't load your files. Please try again later.",
                color: "danger",
            });
        } finally {
            setLoading(false);
    ...
    const handleStarFile = async (fileId: string) => {
        try {
            ...
            addToast({
                title: "Action Failed",
                description:
                    "We couldn't update the star status. Please try again.",
                color: "danger",
            });
        }
    };
    ...
    const handleTrashFile = async (fileId: string) => {
        try {
            ...
            addToast({
                title: "Action Failed",
                description:
                    "We couldn't update the file status. Please try again.",
                color: "danger",
            });
        }
    };
